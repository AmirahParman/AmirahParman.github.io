...
export class ExperiencesComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.datas = [
      new Experience('2023-10-23', '', 'Digital Learning & Development Specialist', 'Piab AB, Sweden', 'Piab', ['Main module developer for Vacuum Automation division', 'Articulate & SANA module developer', 'Key person to liaise with Subject Matter Expert', 'Manages in-house LMS'], ['Automation']),
